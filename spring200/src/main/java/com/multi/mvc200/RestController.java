...
public class RestController {
	...
	public String chart() {
		...
		list.add(makeJSONArray(of("Month", "Bolivia", "Ecuador", "Madagascar", "Papua New Guinea", "Rwanda", "Average")));
		list.add(makeJSONArray(of("2004/05", 165, 938, 522, 998, 450, 614.6)));
		list.add(makeJSONArray(of("2005/06", 135,   1120,    599,       1268,     288,   682)));
		list.add(makeJSONArray(of("2006/07", 157,   1167,    587,       807,      397,   623)));
		list.add(makeJSONArray(of("2007/08", 139,   1110,    615,       968,      215,   609.4)));
		list.add(makeJSONArray(of("2008/09", 136,   691,     629,       1026,     366,   569.6)));
	...
	public JSONArray makeJSONArray(ArrayList<Object> list) {
		JSONArray array = new JSONArray();
		array.addAll(list);
		return array;
	}
